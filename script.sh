...
# grosse resolution et pas de visu
	...
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_1 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_2 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_3 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_4 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_5 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_6 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_7 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_8 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_9 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_10 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result

	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_11 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_12 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_13 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_14 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_15 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_16 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_17 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_18 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_19 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_20 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result

	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_21 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_22 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_23 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_24 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_25 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_26 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_27 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_28 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_29 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_30 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result

	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_31 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_32 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_33 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_34 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_35 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_36 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_37 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_38 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_39 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_40 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result

	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_41 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_42 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_43 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_44 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_45 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_46 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_47 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_48 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_49 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
	$leak  ./lem-in < resources/correct/big_superposition/big_superposition_50 2>> $lem_in_correct > $sortie_verif && make check arg=$sortie_verif arg_2=$result
