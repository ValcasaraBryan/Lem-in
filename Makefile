...
ifeq ($(arg), correct)
	...
	$(leak) ./lem-in < resources/error/10_lots_of_comments.map 2>> $(lem-in_error) | $(leak) ./visu 2>> $(visu_error)
	...
	$(leak) ./lem-in < resources/error/anil 2>> $(lem-in_error) | $(leak) ./visu 2>> $(visu_error)
	$(leak) ./lem-in < resources/error/bad_map 2>> $(lem-in_error) | $(leak) ./visu 2>> $(visu_error)
	$(leak) ./lem-in < resources/error/bad_map2 2>> $(lem-in_error) | $(leak) ./visu 2>> $(visu_error)
	...
	$(leak) ./lem-in < resources/error/invalide_map 2>> $(lem-in_error) | $(leak) ./visu 2>> $(visu_error)
	...
	$(leak) ./lem-in < resources/error/trickytrickymap 2>> $(lem-in_error) | $(leak) ./visu 2>> $(visu_error)
